            ...
            {loading ? (
                ...
                <div className="relative flex flex-col justify-between h-full gap-6 my-auto sm:justify-normal">
                    <div className="p-2 mt-0 sm:p-0 sm:mt-28 ">
                        ...
                        <p className="font-mono text-lg text-center mx-h-[28px] mb-[64px]">
                            {prediction ? (
                    ...
                    <div className="fixed bottom-0 w-full p-2 sm:relative sm:p-0 ">
                        <button
                            onClick={captureFrame}
                            className="px-4 py-3 bg-black bg-opacity-[4%] hover:bg-opacity-[8%] d rounded-[8px] w-full backdrop-blur-md">
